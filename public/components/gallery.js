        ...
        node('div', { class: 'gallery__thumbnails' },
            photos.length ? photos.map((photo) => {
                ...
                if (isNaN(d.getTime())) {
                    ...
                    timestamp = `{{date|${d.getFullYear()}|${padDateComponent(d.getMonth() + 1)}|${padDateComponent(d.getDate())}}}`;
                }
                ...
                // Add the scientific name category to the description
...
[[Category:${scientificName}]]`; // Added scientific name category
